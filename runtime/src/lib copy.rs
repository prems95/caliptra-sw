...
use caliptra_common::memory_layout::{
    ...
    LDEVID_TBS_ORG, LDEVID_TBS_SIZE, MAN1_ORG, MAN1_SIZE, MAN2_ORG, MAN2_SIZE, MBOX_ORG, MBOX_SIZE,
    PCR_LOG_ORG, PCR_LOG_SIZE,
};
...
impl MemoryRegions {
    ...
    fn new() -> Self {
        Self {
            ...
            mbox: unsafe { create_slice(MBOX_ORG, MBOX_SIZE as usize) },
        }
    }
